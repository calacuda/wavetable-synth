...
// use hal::pac::VREG_AND_CHIP_RESET;
use rp235x_pac::{POWMAN, powman::VREG_CTRL};
...
/// Set voltage
///
/// mine voltage  The voltage (from enumeration \ref vreg_voltage) to apply to the voltage regulator
pub fn vreg_set_voltage(vreg_dev: &mut POWMAN, voltage: VregVoltage) {
    // VREG
    vreg_dev
        .vreg()
...
pub fn vreg_get_voltage(vreg_dev: &mut POWMAN) -> u8 {
